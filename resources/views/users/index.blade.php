...
<main class="flex flex-col gap-x-4 w-6/12 mx-auto">
    <header class="flex py-4 justify-evenly w-auto px-6">
        <div class="flex flex-col">
            ...
            <p class="mx-auto inline-flex text-neutral-600 text-md">Estes são os usuários cadastrados</p>
        </div>

        <a href="{{ route('users.register') }}"
            class="inline-flex gap-x-2 items-center bg-teal-600 hover:bg-teal-700 p-2 rounded-xl transition duration-300 ease-in-out cursor-pointer shadow text-sm focus:ring-2 focus:ring-teal-400 text-white">
            Cadastrar usuário
